...
% Fraction of enzymes in the modelREF [g enzyme/g protein]
f     = 0.5;
...
modelREF = setParam(modelREF, 'var', {'r_1992'}, -1.6266, 10);    % O2
modelREF = setParam(modelREF, 'var', {'r_1672'}, 1.8585, 10);    % CO2
...
modelREF = setParam(modelREF, 'var', 'prot_pool_exchange', -99.175, 10);

modelREF   = setParam(modelREF,'var','r_2111',0.045,5);
%modelREF   = setParam(modelREF,'obj','r_2111',1);
%modelREF   = setParam(modelREF,'obj','r_2111',0);

modelREF = setParam(modelREF, 'lb', {'r_1718'}, (-0.678-0.010)); % open xylose
modelREF = setParam(modelREF, 'ub', {'r_1718'}, (-0.678+0.010)); % open xylose
...
modelALT = setParam(modelALT, 'lb', exchangeRxns, 0);
modelALT = setParam(modelALT, 'lb', requiredRxns, -1000);

modelALT = setParam(modelALT, 'var', {'r_1992'}, -2.5135, 10);    % O2
modelALT = setParam(modelALT, 'var', {'r_1672'}, 2.828, 10);    % CO2
...
modelALT = setParam(modelALT, 'var', 'prot_pool_exchange', -97.025, 10);
...
modelALT = setParam(modelALT, 'lb', {'r_1718'}, (-0.634-0.002)); % open xylose
modelALT = setParam(modelALT, 'ub', {'r_1718'}, (-0.634+0.002)); % open xylose

modelALT = setParam(modelALT, 'lb', {'r_1634'}, (-0.861-0.017)); % open acetate
modelALT = setParam(modelALT, 'ub', {'r_1634'}, (-0.861+0.017)); % open acetate
% sol  = solveLP(model,1);
% printFluxes(model, sol.x);
...
writetable(Result, "ATSWovsATSAc.csv");
