classdef ecpapla_GEMAdapter < ModelAdapter
    methods
        function obj = ecpapla_GEMAdapter()
			...
			obj.params.gR_exp = 0.42;

			% Provide your organism scientific name
			obj.params.org_name = 'Papiliotrema laurentii';
			...
			obj.params.uniprot.ID = '367775'; % should match the ID type
